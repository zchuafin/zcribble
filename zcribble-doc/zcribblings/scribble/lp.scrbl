#lang zcribble/doc
@(require zcribble/manual zcribble/core zcribble/html-properties
          zcribble/latex-properties
          racket/runtime-path
          racket/file
          "utils.rkt"
          (prefix-in lp-ex: "lp-ex-doc.scrbl")
          (for-label zcribble/lp-include zcribble/lp))
...
Programs written using @racketmodname[zcribble/lp2] are simultaneously
...
@section{@racketmodname[zcribble/lp2] Language}

@defmodulelang[zcribble/lp2 #:use-sources (zcribble/lp)]{The
@racketmodname[zcribble/lp] language provides core support for
literate programming. It is read like a @racketmodname[zcribble/base]
program, but its bindings extend @racketmodname[zcribble/base] with two
forms: @racket[chunk] and @racket[CHUNK].}

More precisely, a module in @racketmodname[zcribble/lp2] has its
@racketmodname[zcribble/base]-like content in a @racketidfont{doc}
...
To include a @racketmodname[zcribble/lp2] document named
...
@section{@racketmodname[zcribble/lp] Language}

@defmodulelang[zcribble/lp]{Programs written using the older
@racketmodname[zcribble/lp] language are similar to
@racketmodname[zcribble/lp2] programs, except that the module cannot
be provided directly to Scribble. Instead, the document content must be
extracted using @racket[lp-include].}

The @racketmodname[zcribble/lp] language effectively binds only
...
@section{@racketmodname[zcribble/lp-include] Module}

@defmodule[zcribble/lp-include]{The
@racketmodname[zcribble/lp-include] library is normally used within a
Scribble document---that is, a module that starts with something like
@hash-lang[] @racketmodname[zcribble/base] or @hash-lang[] @racketmodname[zcribble/manual],
