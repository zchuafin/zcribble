...
@(require "utils.rkt" (for-label zcribble/sigplan))

@title{SIGPLAN Paper Format}

@defmodulelang[zcribble/sigplan]{The @racketmodname[zcribble/sigplan]
language is like @racketmodname[zcribble/base], but configured with
...
@racketmodname[zcribble/sigplan] and @racket[preprint]:

@verbatim[#:indent 2]|{
  #lang zcribble/sigplan @preprint
}|}
...
same line as @hash-lang[], with only whitespace (or other options) between
@racketmodname[zcribble/sigplan] and @racket[10pt]:

@verbatim[#:indent 2]|{
  #lang zcribble/sigplan @10pt
}|
...
same line as @hash-lang[], with only whitespace (or other options) between
@racketmodname[zcribble/sigplan] and @racket[nocopyright]:

@verbatim[#:indent 2]|{
  #lang zcribble/sigplan @nocopyright
}|}
...
same line as @hash-lang[], with only whitespace (or other options) between
@racketmodname[zcribble/sigplan] and @racket[onecolumn]:

@codeblock|{
  #lang zcribble/sigplan @onecolumn
}|}
...
@racketmodname[zcribble/sigplan] and @racket[notimes]:

@codeblock|{
  #lang zcribble/sigplan @notimes
}|}
