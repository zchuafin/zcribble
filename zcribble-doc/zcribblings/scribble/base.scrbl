...
@defmodulelang[zcribble/base]{The @racketmodname[zcribble/base]
...
forms within a module using the @racketmodname[zcribble/base] language
are treated as document content (like @racketmodname[zcribble/doclang]).

The @racketmodname[zcribble/base] name can also be used as a library
...
have @racketmodname[zcribble/manual]).
...
"zcribblings/reference/reference.scrbl")].
...
The exports of @racketmodname[zcribble/tag] are all re-exported by
