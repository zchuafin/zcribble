...
@(define-syntax-rule (define-new-examples new-examples)
   (begin
     (require (for-label zcribble/example))
...
@defmodule[zcribble/eval]{The @racketmodname[zcribble/eval] library provides
an older interface to the functionality of @racketmodname[zcribble/example].
The @racketmodname[zcribble/example] library should be used, instead.}

In addition to the forms listed below, @racket[zcribble/eval]
re-exports several functions from @racket[zcribble/example]:
@racket[make-base-eval] @racket[make-base-eval-factory],
@racket[make-eval-factory], @racket[make-log-based-eval],
@racket[close-eval], and @racket[zcribble-eval-handler].
...
Like @|new-examples| from @racketmodname[zcribble/example], except that
...
Use @|new-examples| from @racketmodname[zcribble/example], instead.}
...
Use @|new-examples| from @racketmodname[zcribble/example] with the
