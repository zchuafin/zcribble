...
@defmodulelang[zcribble/acmart]{The @racketmodname[zcribble/acmart]
...
@bold{Note:} a @racketmodname[zcribble/acmart] document must include a
...
@racketmodname[zcribble/acmart] and the format name:

@verbatim[#:indent 2]|{
  #lang zcribble/acmart @acmsmall
}|
...
between @racketmodname[zcribble/acmart] and the format option.  Any
number of options may be used:

@verbatim[#:indent 2]|{
  #lang zcribble/acmart @acmsmall @review @anonymous @natbib
}|
...
@code|{#lang zcribble/acmart @natbib[#f] @sigplan}|
...
@defproc[(email-string [text string?] ...) email?]
 ...
 @tech[#:doc '(lib "zcribblings/reference/reference.scrbl") #:key "string"]{strings},
