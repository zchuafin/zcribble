...
@(require (except-in "utils.rkt" author)
          (except-in (for-label zcribble/lncs/lang) #%module-begin))
...
@defmodulelang[zcribble/lncs #:use-sources (zcribble/lncs/lang)]{
  The @racketmodname[zcribble/lncs]
...
@racket[zcribble/lncs] collection, then it is downloaded on demand to
