...
@interaction-eval[#:eval html-eval (require zcribble/html)]
@interaction-eval[#:eval html-eval (require racket/string)]

@title[#:tag "html" #:style 'toc]{HTML Generation}

@defmodulelang[zcribble/html]{The @racketmodname[zcribble/html]
language provides a way to generate HTML that is different from
@racketmodname[zcribble/base]. The @racketmodname[zcribble/base]
approach involves describing a document that can be rendered to HTML,
Latex, or other formats. The @racketmodname[zcribble/html] approach,
in contrast, treats the document content as HTML format plus escapes.}

Specifically, @racketmodname[zcribble/html] is like
@racketmodname[zcribble/text], but with the following changes:

@itemize[

  @item{The @racketmodname[zcribble/html/html],
        @racketmodname[zcribble/html/xml], and
        @racketmodname[zcribble/html/resource] are re-exported,
        in addition to @racketmodname[zcribble/text].}
...
When @racketmodname[zcribble/html] is used via @racket[require]
...
The @racketmodname[zcribble/html/resource],
@racketmodname[zcribble/html/xml], and
@racketmodname[zcribble/html/html] libraries provide forms for
generating HTML as strings to be output in the same way as
@racketmodname[zcribble/text].
...
@defmodule[zcribble/html/html]{The @racketmodname[zcribble/html/html]
...
@defmodule[zcribble/html/extra]

Provides renderers for
@hyperlink["https://html.spec.whatwg.org/multipage/#toc-semantics"]{HTML
elements} that are not provided by @racket[zcribble/html/html].
...
@defmodule[zcribble/html/xml]{The @racketmodname[zcribble/html/xml]
...
@defmodule[zcribble/html/resource]
