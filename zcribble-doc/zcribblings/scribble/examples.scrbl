...
@defmodule[zcribble/example #:use-sources (zcribble/eval zcribble/example)]{The
@racket[zcribble/example] library provides
...
"zcribblings/reference/reference.scrbl")]{serializable}.
...
@defparam[zcribble-eval-handler handler 
...
@defparam[zcribble-exn->string handler (-> (or/c exn? any/c) string?)]{
