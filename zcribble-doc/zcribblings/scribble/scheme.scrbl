#lang zcribble/doc
@(require zcribble/manual "utils.rkt" (for-label zcribble/racket))

@title[#:tag "scheme"]{Racket}

@defmodule*[(zcribble/racket zcribble/scheme)]{The
@racket[zcribble/racket] library (or @racketmodname[zcribble/scheme]
for backward compatibility) provides utilities for typesetting Racket
code. The @racket[zcribble/manual] forms provide a higher-level
interface.}
