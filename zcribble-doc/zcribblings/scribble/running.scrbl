...
@title[#:tag "running"]{Running @exec{zcribble}}

The @exec{zcribble} command-line tool (also available as @as-index{@exec{raco
zcribble}}) runs a Scribble document and renders it to a specific
