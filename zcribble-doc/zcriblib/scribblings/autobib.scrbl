...
@(require (for-label (only-in zcribble/core content?)
                     zcribble/struct
                     zcriblib/autobib
                     racket/base
                     racket/contract))
...
@codeblock[#:keep-lang-line? #f]|{
 #lang zcribble/base
 @citeauthor[zcribble-cite]'s (@citeyear[zcribble-cite])  autobib library is pretty nifty.
}|
