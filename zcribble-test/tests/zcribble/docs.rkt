...
(require zcribble/base-render
         (prefix-in text: zcribble/text-render)
         (prefix-in html: zcribble/html-render)
         (prefix-in latex: zcribble/latex-render)
         (prefix-in markdown: zcribble/markdown-render)
         racket/file 
         racket/class
         racket/runtime-path
         tests/eli-tester)
