...
(define html-provides (phase0-provides 'zcribble/html/html))
(define extra-provides (phase0-provides 'zcribble/html/extra))
...
(check-pred positive?
            ...
            (expected-overlap 'zcribble/html/extra 'racket/base))
